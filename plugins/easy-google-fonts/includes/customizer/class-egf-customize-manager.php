...
if ( ! class_exists( 'EGF_Customize_Manager' ) ) :
	class EGF_Customize_Manager {
		...
		public function customize_live_preview_l10n() {
			...
			$controls      = array();
			$font_controls = array_merge( EGF_Register_Options::get_option_parameters());
		...
		public function customize_control_l10n() {
			...
			$translations = array(
				...
				'confirmation'         => esc_html__( 'This page is asking you to confirm that you want to leave - data you have entered may not be saved.', 'easy-google-fonts' ),
				'deleteAllWarning'     => esc_html__( "Warning! You are about to permanently delete all font controls. 'Cancel' to stop, 'OK' to delete.", 'easy-google-fonts' ),
				'deleteWarning'        => esc_html__( "You are about to permanently delete this font control. 'Cancel' to stop, 'OK' to delete.", 'easy-google-fonts' ),
				'displayFontLabel'     => esc_html__( 'Google Display Fonts', 'easy-google-fonts' ),
				'fallbackFontLabel'    => esc_html__( 'Google Fonts', 'easy-google-fonts' ),
				'handwritingFontLabel' => esc_html__( 'Google Handwriting Fonts', 'easy-google-fonts' ),
				'monospaceFontLabel'   => esc_html__( 'Google Monospace Fonts', 'easy-google-fonts' ),
				'serifFontLabel'       => esc_html__( 'Google Serif Fonts', 'easy-google-fonts' ),
				'sansSerifFontLabel'   => esc_html__( 'Google Sans Serif Fonts', 'easy-google-fonts' ),
				'standardFontLabel'    => esc_html__( 'Standard Web Fonts', 'easy-google-fonts' ),
				'themeDefault'         => '&mdash; ' . esc_html__( 'Theme Default', 'easy-google-fonts' ) . ' &mdash;',
			);
