...
if ( ! class_exists( 'EGF_Register_Options' ) ) :
	class EGF_Register_Options {
		 ...
		 *
		 */
		public static $slug = 'magazin-extras';
		...
		public function validate_settings( $input ) {
			...
			// Get default options
			$all_options = array_merge( self::get_option_parameters() );
		...
		public static function get_setting_tabs() {
			...
			$tabs = array(
				'typography'=> array(
					'name'        => 'typography',
					'title'       => esc_html__( 'Font Family', 'easy-google-fonts' ),
					'panel'       => apply_filters( 'tt_font_typography_panel_id', 'tt_font_typography_panel' ),
					'description' => apply_filters( 'tt_font_typography_description', esc_html__( 'Your theme has typography support. You can create custom font controls on the google fonts screen in the settings section.', 'easy-google-fonts' ) ),
					'sections'    => array(
						// Test section
						'default' => array(
							'name'        => 'default',
							'title'       => esc_html__( 'Default Theme Fonts', 'easy-google-fonts' ),
							'description' => esc_html__( 'Default theme font options', 'easy-google-fonts' ),
						),
					)
				)
			);
		...
		public static function get_panels() {
			$panels = array(
				'tt_font_typography_panel' => array(
					...
					'title'       => esc_html__( 'Theme Fonts', 'easy-google-fonts' ),
					'priority'    => 10,
					'capability'  => 'edit_theme_options',
					'description' => esc_html__( 'Your theme has typography support. You can create custom font controls on the google fonts screen in the settings section.', 'easy-google-fonts' ),
				),
			);
		...
		public static function parse_font_control_array( $args ) {
			$defaults = array(
				'title'       => esc_html__( 'Font Control', 'easy-google-fonts' ),
				'type'        => 'font',
				'description' => esc_html__( "Edit Font", 'easy-google-fonts' ),
				'section'     => 'default',
				'tab'         => 'typography',
		...
		public static function parse_customizer_panel( $args ) {
			$defaults = array(
				'name'        => 'tt_font_typography_panel',
				'title'       => esc_html__( 'Typography', 'easy-google-fonts' ),
				'priority'    => 10,
				'capability'  => 'edit_theme_options',
				'description' => esc_html__( 'Your theme has typography support. You can create custom font controls on the Google Fonts screen in the Settings section.', 'easy-google-fonts' ),
			);
		...
		public static function get_option_parameters() {
			$options = array(
				...
				'tt_default_body' => array(
					...
					'title'       => esc_html__( 'Paragraphs', 'easy-google-fonts' ),
					'description' => esc_html__( "Please select a font for the theme's body and paragraph text", 'easy-google-fonts' ),
					'properties'  => array( 'selector' => apply_filters( 'tt_default_body', 'p' ) ),
				),

				'tt_default_heading_1' => array(
					'name'        => 'tt_default_heading_1',
					'title'       => esc_html__( 'Heading 1', 'easy-google-fonts' ),
					'description' => esc_html__( "Please select a font for the theme's heading 1 styles", 'easy-google-fonts' ),
					'properties'  => array( 'selector' => apply_filters( 'tt_default_heading_1', 'h1' ) ),
				),

				'tt_default_heading_2' => array(
					'name'        => 'tt_default_heading_2',
					'title'       => esc_html__( 'Heading 2', 'easy-google-fonts' ),
					'description' => esc_html__( "Please select a font for the theme's heading 2 styles", 'easy-google-fonts' ),
					'properties'  => array( 'selector' => apply_filters( 'tt_default_heading_h2', 'h2' ) ),
				),

				'tt_default_heading_3' => array(
					'name'        => 'tt_default_heading_3',
					'title'       => esc_html__( 'Heading 3', 'easy-google-fonts' ),
					'description' => esc_html__( "Please select a font for the theme's heading 3 styles", 'easy-google-fonts' ),
					'properties'  => array( 'selector' => apply_filters( 'tt_default_heading_h3', 'h3' ) ),
				),

				'tt_default_heading_4' => array(
					'name'        => 'tt_default_heading_4',
					'title'       => esc_html__( 'Heading 4', 'easy-google-fonts' ),
					'description' => esc_html__( "Please select a font for the theme's heading 4 styles", 'easy-google-fonts' ),
					'properties'  => array( 'selector' => apply_filters( 'tt_default_heading_h4', 'h4' ) ),
				),

				'tt_default_heading_5' => array(
					'name'        => 'tt_default_heading_5',
					'title'       => esc_html__( 'Heading 5', 'easy-google-fonts' ),
					'description' => esc_html__( "Please select a font for the theme's heading 5 styles", 'easy-google-fonts' ),
					'properties'  => array( 'selector' => apply_filters( 'tt_default_heading_h5', 'h5' ) ),
				),

				'tt_default_heading_6' => array(
					'name'        => 'tt_default_heading_6',
					'title'       => esc_html__( 'Heading 6', 'easy-google-fonts' ),
					'description' => esc_html__( "Please select a font for the theme's heading 6 styles", 'easy-google-fonts' ),
					'properties'  => array( 'selector' => apply_filters( 'tt_default_heading_h6', 'h6' ) ),
				),
				'tt_default_heading_0' => array(
					'name'        => 'tt_default_heading_0',
					'title'       => esc_html__( 'Menu', 'easy-google-fonts' ),
					'description' => esc_html__( "Please select a font for the theme's heading 3 styles", 'easy-google-fonts' ),
					'properties'  => array( 'selector' => apply_filters( 'tt_default_heading_0', '.sf-menu a' ) ),
				),
			);
